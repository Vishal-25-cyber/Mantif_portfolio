...
export const mediaConfig = {
  ...
  collectorMedia: {
    ...
    type: 'video' as const,
    src: '/videos/WhatsApp Video 2026-09-19 at 10.26.03 AM.mp4',
    poster: '/images/gallery_5.webp',
  ...
  startupSingamMedia: {
    ...
    type: 'image' as const,
    src: '/images/startup_singam.webp',
    fallbackSrc: '/images/startup_singam.jpg',
  ...
  launchMedia: {
    ...
    type: 'video' as const,
    src: '/videos/mantif_corporate.mp4',
    poster: '/images/gallery_7.webp',
    fallbackSrc: '/images/gallery_7.jpg',
    placeholderAlt: 'MANTIF Launch Milestone',
  },
  hiringSessionMedia: {
    id: 'hiring-session',
    title: 'Educator & Engineering Hiring Session',
    subtitle: 'Conducting live interactive hiring and mentorship sessions to recruit and onboard passionate educators, video creators, and engineers.',
    type: 'image' as const,
    src: '/images/hiring_session.webp',
    fallbackSrc: '/images/hiring_session.jpg',
    placeholderAlt: 'MANTIF Live Hiring and Educator Session',
  },
};
