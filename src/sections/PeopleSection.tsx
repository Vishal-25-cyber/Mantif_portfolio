...
/* ─── Academic Advisory & Mentors ─── */
const ACADEMIC_MENTORS = [
  {
    id: 'revathi',
    name: 'Dr. A. Revathi',
...
/* ─── Academic Mentor Flip Card ─── */
interface FlipCardProps {
  member: (typeof ACADEMIC_MENTORS)[0];
}
const AcademicMentorCard: React.FC<FlipCardProps> = ({ member }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* FRONT */}
        <div
          className="absolute inset-0 rounded-3xl overflow-hidden border border-[#002137]/10 bg-[#FAF8F5] shadow-sm"
          style={{
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, rgba(0,17,29,0.88) 0%, rgba(0,17,29,0.15) 55%, transparent 100%)',
            }}
          />
          {/* Group pill */}
          ...
          <div className="absolute bottom-5 left-5 right-5">
            <div className="font-serif font-bold text-[#FAF8F5] leading-tight text-xl sm:text-2xl">
              {member.name}
            </div>
            <div
            ...
            <div className="font-mono text-[8px] text-[#FAF8F5]/45 mt-3 uppercase tracking-wider">
        ...
        <div
          ...
          style={{
            ...
            border: `1px solid ${member.groupColor}60`,
          }}
        >
          <div
            className="absolute top-0 left-6 right-6 h-[2px] rounded-full"
            style={{
              background: `linear-gradient(to right, ${member.groupColor}, transparent)`,
            }}
          />
          <div>
            <span
            ...
            <h3 className="font-serif font-bold text-[#FAF8F5] mt-2 leading-tight text-xl sm:text-2xl">
              {member.name}
            </h3>
            <p className="font-mono text-[10px] font-semibold mt-1 text-[#93C5FD]">
              {member.sub}
            </p>
          </div>
          <div className="border-y border-[#004B79]/25 py-3 my-2">
            <p className="font-serif italic text-xs sm:text-sm text-[#FAF8F5]/90 leading-snug">
              "{member.quote}"
            </p>
          </div>
          <p className="font-sans text-xs text-[#94A3B8] leading-relaxed line-clamp-3 flex-1 mb-2">
            {member.bio}
          </p>
          <div className="pt-3 border-t border-[#004B79]/20">
            <div className="font-mono text-[8px] tracking-[0.2em] text-[#64748B] uppercase mb-1">
              Key credentials
            </div>
            <p className="font-mono text-[10px] font-semibold text-[#93C5FD]">
              {member.fact}
            </p>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8">
        ...
        {/* ═════════════════════════════════════════════════════════════════════════ */}
        {/* ACADEMIC ADVISORY & PEDAGOGICAL MENTORS                                  */}
        {/* ═════════════════════════════════════════════════════════════════════════ */}
        <div className="pt-12 border-t border-[#002137]/10">
          <div className="flex flex-col items-center justify-center text-center mb-8">
            ...
            <p className="font-mono text-[10px] text-[#64748B] mt-2 tracking-wider">
              Click either card to inspect academic credentials
            </p>
          </div>

          {/* 2 Mentor Flip Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 max-w-2xl mx-auto gap-6">
            {ACADEMIC_MENTORS.map((m) => (
              <AcademicMentorCard key={m.id} member={m} />
            ))}
          </div>
        </div>
